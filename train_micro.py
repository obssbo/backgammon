...
# -*- coding: utf-8 -*-
"""
Training script for MICRO-ACTION agent (agent_ac_adv_micro.py)
"""
...
import agent_ac_adv_micro as agent  # MICRO: micro-action, state-value critic

CKPT_DIR = Path("checkpoints/micro")
CKPT_DIR.mkdir(parents=True, exist_ok=True)

LOG_FILE = Path("results/micro_learning_curve.json")
...
def train(n_games=200_000, n_epochs=5_000, n_eval=500):
    ...
    print("=" * 60)
    print("TRAINING MICRO-ACTION AGENT (agent_ac_adv_micro.py)")
    print("Micro-action, state-value critic")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"MICRO-ACTION TRAINING COMPLETE")
